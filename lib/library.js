...
var _recon = __webpack_require__(1);

var _recon2 = _interopRequireDefault(_recon);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

exports.default = _recon2.default;
...
exports.reduxController = undefined;
...
var reduxController = exports.reduxController = function reduxController() {
  ...
  function reducer() {
    ...
    var action = actionHandlers[type];

    return action && typeof action.handler === 'function' ? action.handler(state, payload) : state;
  }

  var mappedSelectors = Object.keys(selectors).reduce(function (selectorsObj, key) {
    return Object.assign({}, selectorsObj, _defineProperty({}, key, selectors[key]));
  }, {});

  // Map action handlers to actions
  var actions = Object.keys(actionHandlers).reduce(function (actionsObj, key) {
    (0, _invariant2.default)(actionsObj['key'], 'You must provide actions with a unique key. Please check for a duplicate of ' + key);
    (0, _invariant2.default)(key !== '', "An action must not be '' ");

    return Object.assign({}, actionsObj, _defineProperty({}, key, Object.assign(function () {
      var _actionHandlers$key;
...
exports.default = reduxController;
